...
const file_proto_health_proto_rawDesc = "" +
	"\n" +
	"\x12proto/health.proto\x12\x15standard_tools.health\"\x14\n" +
	"\x12HealthCheckRequest\"-\n" +
	"\x13HealthCheckResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2h\n" +
	"\x06Health\x12^\n" +
	"\x05Check\x12).standard_tools.health.HealthCheckRequest\x1a*.standard_tools.health.HealthCheckResponseB7Z5github.com/kevincouton/standard-tools-go/proto/healthb\x06proto3"
...
var file_proto_health_proto_goTypes = []any{
	(*HealthCheckRequest)(nil),  // 0: standard_tools.health.HealthCheckRequest
	(*HealthCheckResponse)(nil), // 1: standard_tools.health.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: standard_tools.health.Health.Check:input_type -> standard_tools.health.HealthCheckRequest
	1, // 1: standard_tools.health.Health.Check:output_type -> standard_tools.health.HealthCheckResponse
