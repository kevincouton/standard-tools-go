#!/usr/bin/env bash
# Generates a visual HTML report from `go test` output.
set -euo pipefail
...
<body>
  <div class="card">
    <h1>Standard-Tools Go Test Report</h1>
    <div class="status">$STATUS</div>
    <div class="stats">
      <div class="stat"><div class="number">$PASSED</div><div>Packages Passed</div></div>
      <div class="stat"><div class="number">$FAILED</div><div>Packages Failed</div></div>
    </div>
    <h2>Raw Output</h2>
